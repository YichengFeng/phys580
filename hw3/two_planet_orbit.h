...
public:
	...
	void increase_vy2_start(double r);
...
inline void TwoPlanetOrbit::increase_vy2_start(double r) { _vy2_start *= r; _c_start[7] = _vy2_start; }
...
inline void TwoPlanetOrbit::set_m1(double m1) { _m1 = m1; }
inline void TwoPlanetOrbit::set_m2(double m2) { _m2 = m2; }
